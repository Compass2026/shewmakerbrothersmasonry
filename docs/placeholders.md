...
Generated by `node qa/placeholders.mjs` from the built site on 2026-09-08: 51 visible placeholder blocks across 34 pages. Every one is a real block on staging with a dashed brick border; none may be "fixed" by inventing content.
