...
Generated by `node qa/placeholders.mjs` from the built site on 2026-09-08: 55 visible placeholder blocks across 34 pages. Every one is a real block on staging with a dashed brick border; none may be "fixed" by inventing content.

| Page | Slot | What is needed | Why |
| --- | --- | --- | --- |
| `/` | feature | The fireplace, pizza oven and grill: uncropped original at 1600 px or wider, 3:2. An evening or in-use shot if there is one. | No original wide enough for the slot |
| `/` | hero | Hero: the finished stone seawall with the lake house above and water in frame. Uncropped original, 2400 px or wider. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
| `/` | portrait | Mike and Sam, faces, on a job site. Square crop at 1200 px. | No portrait or additional crew photography exists |
...
| `/about/` | hero | Hero: Mike and Sam with the crew on a job site, faces visible, uncropped original at 2400 px. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
| `/about/` | portrait | Mike and Sam, faces, on a job site. Portrait crop at 1200 px. | No portrait or additional crew photography exists |
| `/about/` | story-brothers | How Mike and Sam came into the trade. | Unverified fact; stays out of the copy until Sam confirms it |
| `/about/` | story-crews | The crews: how many, how long they have worked together. | Unverified fact; stays out of the copy until Sam confirms it |
| `/about/` | story-origin | Who the first generation was and roughly when the trade came into the family. Sam to tell it; nothing is published until he does. | Unverified fact; stays out of the copy until Sam confirms it |
| `/about/` | story-project | A signature local project people would recognise, if there is one Sam wants named. | Unverified fact; stays out of the copy until Sam confirms it |
| `/block-masonry/` | hero | Hero: Block or structural masonry, in progress or finished, uncropped original. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
...
| `/blog/` | blog-posts | The first five posts are planned below and not written. Each is seeded from the content signal in docs/keyword-map.md; none is published until it is real. | No posts written yet |
| `/blog/` | hero | Blog hero: a close-up of stone and joint work, the hand of the mason, uncropped original at 2400 px. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
| `/brick-masonry/` | hero | Hero: A brick project exterior, uncropped original, plus what the arched doorway project was. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
...
| `/chimney-construction/` | hero | Hero: A new chimney exterior, uncropped original at 2400 px. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
...
| `/chimney-repair/` | hero | Hero: Chimney repair, before and after, uncropped originals. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
...
| `/commercial-masonry/` | hero | Hero: A commercial project exterior, uncropped original at 2400 px. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
...
| `/concrete/` | hero | Hero: Concrete flatwork: a slab, driveway or patio pour, uncropped original at 2400 px. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
...
| `/contact/` | hero | Contact hero: Sam on a job site, or the crew at work, uncropped original at 2400 px. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
| `/excavation/` | hero | Hero: Excavation or site prep with equipment on site, uncropped original at 2400 px. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
| `/indoor-fireplaces/` | hero | Hero: The indoor stacked-stone fireplace, uncropped original at 2400 px. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
...
| `/lakefront-retaining-walls/` | hero | Hero: Finished lakefront retaining wall seen from the water, uncropped original at 2400 px. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
| `/lakefront-stairs/` | hero | Hero: Stone stairs running down to a dock with the water in frame, uncropped original at 2400 px. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
| `/masonry-repair/` | hero | Hero: Tuckpointing or repointing, before and after, uncropped originals. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
| `/outdoor-fireplaces/` | hero | Hero: The outdoor fireplace, uncropped original at 2400 px; an evening or in-use shot if there is one. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
...
| `/outdoor-kitchens/` | hero | Hero: A finished outdoor kitchen with counters and a built-in grill, uncropped original at 2400 px. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
...
| `/patios/` | hero | Hero: The finished flagstone patio (the one photographed in progress), uncropped original at 2400 px. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
| `/pizza-ovens/` | hero | Hero: The pizza oven, uncropped original, close enough to read the oven mouth and the stone. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
...
| `/projects/` | hero | Gallery hero: finished seawall with water in frame in summer, uncropped original at 2400 px. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
| `/retaining-walls/` | hero | Hero: A finished retaining wall, uncropped original; before and after of a failed wall if there is one. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
| `/seawall-construction/` | hero | Hero: Finished stone seawall with the lake house above and water in frame, uncropped original at 2400 px, summer light if there is one. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
| `/seawall-repair/` | hero | Hero: Before and after of a failed shoreline: the eroded bank, then the finished mortared stone wall, from the same spot. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
...
| `/service-area/` | hero | Hero: finished seawall with water in frame in summer, uncropped original at 2400 px. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
| `/service-area/camdenton/` | hero | Hero: finished lakefront work photographed in or near Camdenton, water in frame, uncropped original at 2400 px. No location is known for any current photo, so this slot stays a placeholder until Sam supplies one. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
| `/service-area/eldon/` | hero | Hero: finished lakefront work photographed in or near Eldon, water in frame, uncropped original at 2400 px. No location is known for any current photo, so this slot stays a placeholder until Sam supplies one. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
| `/service-area/gravois-mills/` | hero | Hero: finished lakefront work photographed in or near Gravois Mills, water in frame, uncropped original at 2400 px. No location is known for any current photo, so this slot stays a placeholder until Sam supplies one. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
| `/service-area/horseshoe-bend/` | hero | Hero: finished lakefront work photographed in or near Horseshoe Bend, water in frame, uncropped original at 2400 px. No location is known for any current photo, so this slot stays a placeholder until Sam supplies one. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
| `/service-area/lake-ozark/` | hero | Hero: finished lakefront work photographed in or near Lake Ozark, water in frame, uncropped original at 2400 px. No location is known for any current photo, so this slot stays a placeholder until Sam supplies one. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
| `/service-area/laurie/` | hero | Hero: finished lakefront work photographed in or near Laurie, water in frame, uncropped original at 2400 px. No location is known for any current photo, so this slot stays a placeholder until Sam supplies one. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
| `/service-area/osage-beach/` | hero | Hero: finished lakefront work photographed in or near Osage Beach, water in frame, uncropped original at 2400 px. No location is known for any current photo, so this slot stays a placeholder until Sam supplies one. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
| `/service-area/sunrise-beach/` | hero | Hero: finished lakefront work photographed in or near Sunrise Beach, water in frame, uncropped original at 2400 px. No location is known for any current photo, so this slot stays a placeholder until Sam supplies one. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
| `/service-area/versailles/` | hero | Hero: finished lakefront work photographed in or near Versailles, water in frame, uncropped original at 2400 px. No location is known for any current photo, so this slot stays a placeholder until Sam supplies one. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
| `/stone-veneer/` | hero | Hero: Exterior stone veneer on a house, uncropped original at 2400 px. | A 414 px thumbnail cannot fill a hero; full-resolution original needed |
